...
import com.ritwik.rai.locatefactory.R;
import com.ritwik.rai.locatefactory.constant.Url;
...
public class VolleyTaskManager {
    ...
    public void doPostFactoryLocation(HashMap<String, String> paramsMap, boolean isToShowDialog) {
        this.isToShowDialog = isToShowDialog;
        String url = Url.POST_FACTORY_LOCATION_URL;
        int method = Method.POST;

        Log.e("url", url);
        Log.e("Params", "" + paramsMap);
